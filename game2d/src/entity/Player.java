...
//		gp.currentMap = 3;
		...
		dexterity = 1; // the more dexterity he has, the less damaga he receives.
		exp = 0;
		nextLevelExp = 5;
		coin = 100;
		...
		attack = getAttack(); //total attack value is decide by trength anh weapon
		defense = getDefense(); //total defense valude is decide by dexterity and shield
...
//		inventory.add(new OBJ_Key(gp));
	...
	if(knockBack == true) {
		...
		if(gp.keyH.shotKeyPressed == true && projectile.alive == false && 
			...
			//SET DAFAULT COORDINATES, DIRECTION  AND USER
		...
		if(i != 999) {
			...
			// INVENTORY ITEMS
				...
				if(canObtainItem(gp.obj[gp.currentMap][i]) == true) {
					...
					text = "You cannot carry nay more!";
				}
...
//		g2.drawString("invincale:" + invincibleCounter, 10, 400);
	}
